...
const sutra_iast = ["a i u ṇ", "ṛ ḷ k", "e o ṅ", "ai au c", "ha ya va ra ṭ", "la ṇ", "ñ m ṅ ṇ n m", "jh bh ñ", "gh ḍh dh ṣ", "j b g ḍ d ś", "kh ph ch ṭh th c ṭ t v", "ka pa y", "śa ṣa sa r", "ha l", "🕉", "space" ];

const sutra_kannada = ["అఇಉಣ್", "ಋ ಌ ಕ್", "ಏ ಓ ಙ್", "ಐ ಔ ಚ್", "ಹಯವರಟ್", "ಲ ಣ್", "ಞಮಙಣನಮ್", "ಝ ಭ ಞ್", "ಘ ಢ ಧ ಷ್", "ಜಬಗಡದಶ್", "ಖಫಛಠಥಚಟತವ್", "ಕ ಪ ಯ್", "ಶ ಷ ಸ ರ್", "ಹ ಲ್", "🕉", "space"];

const sutra_telugu = ["అ ఇ ఉ ణ్", "ఋ ఌ క్", "ఏ ఓ ఙ్", "ఐ ఔ చ్", "హయవరట్", "ల ణ్", "ఞమఙణనమ్", "ఝ భ ఞ్", "ఘ ఢ ధ ష్", "జబగడదశ్", "ఖఫఛఠథచటతవ్", "క ప య్", "శ ష స ర్", "హ ల్", "🕉", "space"];

const alphabets_devanagiri = ["अ","इ","उ","ऋ","ऌ","ए","ऐ","ओ","औ","क","ख","ग","घ","ङ","च","छ","ज","झ","ञ","ट","ठ","ड","ढ","ण","त","थ","द","ध","न","प","फ","ब","भ","म","य","र","ल","व","श","ष","स","ह"];

const alphabets_iast = ["a","i","u","ṛ","ḷ","e","ai","o","au","ka","kha","ga","gha","ṅa","ca","cha","ja","jha","ña","ṭa","ṭha","ḍa","ḍha","ṇa","ta","tha","da","dha","na","pa","pha","ba","bha","ma","ya","ra","la","va","śa","ṣa","sa","ha"];

const alphabets_kannada = ["అ","ఇ","ಉ","ಋ","ಌ","ಏ","ಐ","ಓ","ಔ","ಕ","ಖ","ಗ","ಘ","ಙ","ಚ","ಛ","ಜ","ಝ","ಞ","ಟ","ಠ","ಡ","ಢ","ಣ","ತ","ಥ","ದ","ಧ","ನ","ಪ","ಫ","ಬ","ಭ","ಮ","ಯ","ರ","ಲ","ವ","ಶ","ಷ","ಸ","ಹ"];

const alphabets_telugu  = ["అ","ఇ","ఉ","ఋ","ఌ","ఏ","ఐ","ఓ","ఔ","క","ఖ","గ","ఘ","ఙ","చ","ఛ","జ","ఝ","ఞ","ట","ఠ","డ","ఢ","ణ","త","థ","ద","ధ","న","ప","ఫ","బ","భ","మ","య","ర","ల","వ","శ","ష","స","హ"];
...
function CreateGame() {
  ...
  script_id = document.querySelector('input[name="script"]:checked').value;
  ...
  if (challenge_id == 1) {
    ...
    if (script_id==1)
      ...
      alphabets = alphabets_iast;
    else if (script_id==3)
      alphabets = alphabets_kannada;
    else if (script_id==4)
      alphabets = alphabets_telugu;
